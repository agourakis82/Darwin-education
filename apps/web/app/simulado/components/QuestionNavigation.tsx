...
export function QuestionNavigation({
  ...
  const statusStyles = {
    ...
    answered: 'bg-slate-700 text-white border-slate-600',
    flagged: 'bg-yellow-600/20 text-yellow-400 border-yellow-600',
    unanswered: 'bg-slate-800 text-slate-400 border-slate-700 hover:border-slate-600',
  }
      ...
      <div className="mt-4 pt-4 border-t border-slate-800">
        <div className="grid grid-cols-2 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-xs text-slate-400">Marcadas</div>
          </div>
        </div>
      </div>
    </div>
