    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <select
          ...
          className="w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-2 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
        >
          {AREAS.map((area) => (
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            config.requireClinicalCase ? 'bg-primary-600' : 'bg-gray-600'
          }`}
        >
          <span
