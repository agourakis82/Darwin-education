  ...
  useEffect(() => {
    async function loadResult() {
      ...
      if (isSubmitted && result && currentPuzzle?.id === puzzleId) {
        ...
        setTimeout(() => celebrateCIPResult({ scaledScore: result.scaledScore, percentageCorrect: result.percentageCorrect, passed: result.passed }), 500)
        return
      }
      ...
      // Celebrate the result!
      setTimeout(() => celebrateCIPResult({ scaledScore: score.scaledScore, percentageCorrect: score.percentageCorrect, passed: score.passed }), 500)
    }
