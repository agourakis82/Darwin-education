...
export function AchievementBadge({
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isLocked && (
          ...
          >
            ...
            {achievement.tier === 'silver' && <Award className="w-3 h-3 text-label-tertiary" />}
        ...
        <div className="text-center max-w-[200px]">
          <h3
            className={cn(
              ...
              isLocked ? 'text-label-tertiary' : 'text-label-primary'
            )}
          >
      ...
      {/* Tooltip on Hover */}
      {!showDetails && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-surface-2 border border-separator rounded-lg text-xs text-label-primary whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-dropdown">
