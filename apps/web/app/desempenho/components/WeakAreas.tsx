        ...
        <CardContent>
          <div className="text-center py-4">
            {hasData ? (
              ...
              <>
                <div className="w-12 h-12 bg-surface-2rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-label-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <p className="text-sm text-label-secondary">Sem dados suficientes</p>
          ...
          {weakAreas.map(([area, score]) => (
            <div key={area} className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg hover:border-red-500/40 transition-colors">
              ...
              <p className="text-xs text-label-secondary">
                <span className="font-medium text-label-primary">Recomendação:</span> {areaRecommendations[area]}
              </p>
            </div>
          ))}
        </div>
