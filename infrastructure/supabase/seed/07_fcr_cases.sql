...
(
  ...
  '[
    {"id":"preec-conduta-1","textPt":"Sulfato de magnésio IV (neuroproteção) + anti-hipertensivo (hidralazina ou nifedipina) + corticoide + programar parto","isCorrect":true,"explanationPt":"Terapia completa: MgSO4 previne eclâmpsia (NNT=100 para pré-ec grave), anti-HT trata crise (meta: PAD 90-100), corticoide amadurece pulmão fetal <34sem, parto é cura definitiva.","clinicalPearlPt":"MgSO4: ataque 4-6g IV 20min, manutenção 1-2g/h. Monitorar reflexo patelar, FR, diurese (intoxicação: arreflexia, FR<12, oligúria). Antídoto: gluconato de Ca 1g IV."},
